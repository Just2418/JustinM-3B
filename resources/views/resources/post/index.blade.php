                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="delete-form-{{$post->id}}" action="{{ route('post.destroy', $post->id) }}" method="post" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn btn-danger m-1" data-confirm="Are you sure you want to delete this post?" onclick="confirmDelete('delete-form-{{$post->id}}')"><i class="bi bi-trash-fill"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
